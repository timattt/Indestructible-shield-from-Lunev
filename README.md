...
## IV
1) Когда процесс уходит из таблицы процессов?    
когда родитель сделал wait
2) Можно ли сделать так чтобы дети не оставались в таблице?   
Да, заменить дефолтный обработчик SIGCHLD у родителя на SIGIGN
3) Какие сигналы могут быть разосланы при выходе процесса?
